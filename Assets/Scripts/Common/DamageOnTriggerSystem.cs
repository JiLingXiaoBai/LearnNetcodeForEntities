...
public partial struct DamageOnTriggerSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        {
            DamageOnTriggerLookup = state.GetComponentLookup<DamageOnTrigger>(true),
            TeamLookup = state.GetComponentLookup<MobaTeam>(true),
            AlreadyDamagedLookup = state.GetBufferLookup<AlreadyDamagedEntity>(true),
            DamageBufferLookup = state.GetBufferLookup<DamageBufferElement>(true),
